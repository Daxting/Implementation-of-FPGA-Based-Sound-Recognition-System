...
//internal wires for AC
    initial_mux initial_mux_inst_A0(
        ...
        .B_write_enable(initial_write_enable[0]),
    ...
    initial_mux initial_mux_inst_A1(
        ...
        .B_write_enable(initial_write_enable[1]),
        .select_A(select_bramA),
        //output
    ...
    initial_mux initial_mux_inst_A2(
        ...
        .B_write_enable(initial_write_enable[2]),
        .select_A(select_bramA),
        //output
    ...
    initial_mux initial_mux_inst_A3(
        ...
        .B_write_enable(initial_write_enable[3]),
        .select_A(select_bramA),
        //output
    ...
    initial_mux initial_mux_inst_C0(
        ...
        .B_addr(write_addr_0),
        .A_write_enable(initial_write_enable[0]),
    ...
    initial_mux initial_mux_inst_C1(
        ...
        .B_addr(write_addr_1),
        .A_write_enable(initial_write_enable[1]),
    ...
    initial_mux initial_mux_inst_C2(
        ...
        .B_addr(write_addr_2),
        .A_write_enable(initial_write_enable[2]),
    ...
    initial_mux initial_mux_inst_C3(
        ...
        .B_addr(write_addr_3),
        .A_write_enable(initial_write_enable[3]),
